    ...
    <div className="canvas">
      ...
      <NumberedList
        ...
        steps={[
          {
            lead: "Carve",
            body: "the image is first split into uniform, connected regions.",
          },
          {
            lead: "Assign",
            body: "each region is judged figure or ground: object, or backdrop.",
          },
          {
            lead: "Group",
            body: "the surviving elements are clustered by the grouping principles.",
          },
        ]}
        closer={
          <>
            Palmer &amp; Rock's insight: grouping isn't first. The system{" "}
            <strong>partitions the image before it groups anything</strong> —
            and that partition can override the rest.
          </>
        }
      />
      ...
      <NumberedList
        ...
        steps={[
          {
            lead: "Proximity",
            body: "elements close together are read as one group.",
          },
          {
            lead: "Similarity",
            body: "elements sharing color, size, or shape are grouped.",
          },
          {
            lead: "Common fate",
            body: "elements moving together are grouped.",
          },
          {
            lead: "Good continuation",
            body: "elements on a smooth path are grouped; the eye prefers continuity over abrupt change.",
          },
          {
            lead: "Closure",
            body: "incomplete figures are perceived as whole.",
          },
          {
            lead: "Symmetry / order",
            body: "regular, symmetrical arrangements are grouped and preferred.",
          },
        ]}
        closer={
          <>
